...
On the test set, **R²** ≈ **0.15** means the model explains about **15%** of the variance in `**success_composite_v1`**.
...
The full ranking is in `outputs/supervised/permutation_importance.csv`. The figure is below.

Permutation importance (Ridge, test set)
